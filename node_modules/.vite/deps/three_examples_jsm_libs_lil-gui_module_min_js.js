...
var s = { isPrimitive: true, match: (t2) => typeof t2 == "string", fromHexString: e, toHexString: e };
var n = { isPrimitive: true, match: (t2) => typeof t2 == "number", fromHexString: (t2) => parseInt(t2.substring(1), 16), toHexString: (t2) => "#" + t2.toString(16).padStart(6, 0) };
var r = { isPrimitive: false, match: Array.isArray, fromHexString(t2, i2, e2 = 1) {
...
var d = class extends t {
  ...
  _initInput() {
    ...
    this.$input.addEventListener("input", () => {
      ...
      i3.code === "Enter" && this.$input.blur(), i3.code === "ArrowUp" && (i3.preventDefault(), t2(this._step * this._arrowKeyMultiplier(i3))), i3.code === "ArrowDown" && (i3.preventDefault(), t2(this._step * this._arrowKeyMultiplier(i3) * -1));
...
var c = class extends t {
  ...
  updateDisplay() {
    ...
    return this.$select.selectedIndex = i2, this.$display.innerHTML = i2 === -1 ? t2 : this._names[i2], this;
  }
};
...
var p = false;
var g = class {
  constructor({ parent: t2, autoPlace: i2 = t2 === void 0, container: e2, width: s2, title: n2 = "Controls", injectStyles: r2 = true, touchStyles: l2 = true } = {}) {
  ...
  _callOnFinishChange(t2) {
    this.parent && this.parent._callOnFinishChange(t2), this._onFinishChange !== void 0 && this._onFinishChange.call(this, { object: t2.object, property: t2.property, value: t2.getValue(), controller: t2 });
  }
  destroy() {
